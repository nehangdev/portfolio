...
export const projects: Project[] = [
  ...
  },
  {
    ...
    summary:
      'A social media application for trading and crypto enthusiasts, built with agentic AI tooling and subscription payments.',
    stack: [
      'ASP.NET 9',
      'React',
      'Agentic AI',
  ...
  },
  {
    ...
    summary:
      "A content management system purpose-built as a fintech firm's internal knowledge base.",
  ...
  },
  {
    ...
    summary:
      'Centralised identity service securing service-to-service access using the OAuth 2.0 client credentials flow.',
    stack: [
      'ASP.NET Core',
      'IdentityServer 4',
      'Azure AD B2C',
  ...
  },
  {
    ...
    summary:
      'Real-time charting and trading-tools dashboards for crypto trading, built as reusable Web Components.',
  ...
  },
  {
    ...
    summary:
      'ERP software to run medical testing laboratories of any size: sample tracking, test workflows and reporting.',
  ...
  },
  {
    ...
    summary:
      'Automates creation of Batch Manufacturing Records (BMR) and Batch Packaging Records (BPR) for medicines.',
